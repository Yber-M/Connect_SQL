...
namespace GLOBTECx_Cars
{
    public partial class FrmUpdateDtsCars : Form
    {
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            string cadena = "UPDATE vehiculo SET Placa = '" + placa + "', Marca = '" 
            ...
            if (cant == 1)
            {
                ...
                lblStatus.Text = "Datos del Carro ID[" + id + "] ACTUALIZADO con éxito";
